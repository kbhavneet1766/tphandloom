...
<body>
    ...
    <section class="products section container" id="products">
        ...
        <article class="products__card">
                <img src="./img/co7.png" alt="" class="products__img">

                <h3 class="products__title">Comforter</h3>
            ...
            <article class="products__card">
                <img src="./img/co8.png" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co1.jpeg" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co2.jpeg" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co3.jpeg" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co4.jpeg" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co5.jpeg" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co6.jpeg" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co9.png" alt="" class="products__img">
            ...
            <article class="products__card">
                <img src="./img/co10.png" alt="" class="products__img">
