...
<div class="mySlides">
    ...
    <img src="./img/bed16.jpg" style=" border:2px solid #ddd;
    height:450px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/bed12.jpg" style=" border:2px solid #ddd;
    height:450px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/bed13.jpg" style=" border:2px solid #ddd;
    height:450px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/bed14.jpg" style=" border:2px solid #ddd;
    height:450px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/bed11.jpg" style=" border:2px solid #ddd;
    height:450px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="row">
  <div class="column">
      <img class="demo2" src="./img/bed16.jpg" style="width:100%" onclick="currentSlide(5)" alt="Tiny Toon Bedsheet">
    </div>  
    <div class="column">
      <img class="demo2" src="./img/bed12.jpg" style="width:100%" onclick="currentSlide(1)" alt="Tiny Toon Bedsheet">
    </div>
    <div class="column">
      <img class="demo2" src="./img/bed13.jpg" style="width:100%" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>
    <div class="column">
      <img class="demo2" src="./img/bed14.jpg" style="width:100%" onclick="currentSlide(3)" alt="Tiny Toon Bedsheet">
    </div>
    <div class="column">
      <img class="demo2" src="./img/bed11.jpg" style="width:100%" onclick="currentSlide(4)" alt="Tiny Toon Bedsheet">
    </div>
