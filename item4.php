...
<div class="mySlides">
  ...
  <div class="mySlides">
    <img src="./img/bed41.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/bed42.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
   ...
   <img src="./img/bed43.jpeg" style=" border:2px solid #ddd;
   height:430px;
   border-radius:4px;
   padding:5px;
   width:450px;">
  ...
  <div class="row">
  <div class="column">
      <img class="demo2" src="./img/b17.jpeg"  onclick="currentSlide(5)" alt="Tiny Toon Bedsheet">
</div>
    <div class="column">
      <img class="demo2" src="./img/bed41.jpeg"  onclick="currentSlide(1)" alt="Tiny Toon Bedsheet">
    </div>
    <div class="column">
      <img class="demo2" src="./img/bed42.jpeg" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>
     <div class="column">
      <img class="demo2" src="./img/bed43.jpeg" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>
