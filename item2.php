...
Weight 600grams<br></h3>
             <button type="submit" name="Add_To_Cart" class="btn btn-info" >Add to Cart</img></button>
...
<div class="mySlides">
  ...
  <div class="mySlides">
    <img src="./img/bed21.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/bed22.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="row">
  <div class="column">
      <img class="demo2" src="./img/b13.jpeg"  onclick="currentSlide(5)" alt="Tiny Toon Bedsheet">
</div>
    <div class="column">
      <img class="demo2" src="./img/bed21.jpeg"  onclick="currentSlide(1)" alt="Tiny Toon Bedsheet">
    </div>
    <div class="column">
      <img class="demo2" src="./img/bed22.jpeg" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>
