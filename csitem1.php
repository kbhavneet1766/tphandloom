...
<div class="mySlides">
  ...
  <div class="mySlides">
    <img src="./img/c11.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/c12.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    ...
    <img src="./img/c13.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    <img src="./img/c14.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="mySlides">
    <img src="./img/c15.jpeg" style=" border:2px solid #ddd;
    height:430px;
    border-radius:4px;
    padding:5px;
    width:450px;">
  ...
  <div class="row">
  <div class="column">
      <img class="demo2" src="./img/c1.jpeg"  onclick="currentSlide(5)" alt="Tiny Toon Bedsheet">
</div>
    <div class="column">
      <img class="demo2" src="./img/c11.jpeg"  onclick="currentSlide(1)" alt="Tiny Toon Bedsheet">
    </div>
    <div class="column">
      <img class="demo2" src="./img/c12.jpeg" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>
    <div class="column">
      <img class="demo2" src="./img/c13.jpeg" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>
    
    <div class="column">
      <img class="demo2" src="./img/c14.jpeg" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>

    <div class="column">
      <img class="demo2" src="./img/c15.jpeg" onclick="currentSlide(2)" alt="Tiny Toon Bedsheet">
    </div>
  </div>
</div>
